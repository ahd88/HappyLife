  			...
  			<div class="tab-content">
			    ...
			    <div id="howilook" class="tab-pane fade in active">
			    	...
			    	<div id="" class="grid-container">
			    		<form action="${pageContext.request.contextPath}/aboutmesaved" method="POST">
							<div class="row">								
								<div class="col-12">
									<textarea class="col-12" name="AboutMe" id="profiletextarea" rows="7" cols="100">${AboutMeInfo}</textarea>
								</div>
							</div>
							<br>
