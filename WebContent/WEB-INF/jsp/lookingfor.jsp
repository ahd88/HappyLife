  			...
  			<div class="tab-content">
			    ...
			    <div id="howilook" class="tab-pane fade in active">
			    	...
			    	<div id="" class="grid-container">
			    		<form action="${pageContext.request.contextPath}/lookingforsaved" method="POST">
							<div class="row">								
								<div class="col-12">
									<textarea class="col-12" name="LookingFor" id="profiletextarea" rows="7" cols="100">${LookingForInfo}</textarea>
								</div>
							</div>
							<br>
